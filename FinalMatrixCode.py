...
class GraphicsTest(SampleBase):
    ...
    def run(self):
        ...
        twocolor = graphics.Color(238,53,46)
        fourcolor = graphics.Color(0, 147, 60)
        while asd == True:
            graphics.DrawText(canvas, font, 2, 7, twocolor, subwaytimeslist[0])
            graphics.DrawText(canvas, font, 2, 15, fourcolor, subwaytimeslist[1])
            graphics.DrawText(canvas, font, 2, 23, twocolor, subwaytimeslist[2])
            graphics.DrawText(canvas, font, 2, 31, fourcolor, subwaytimeslist[3])
